...
module.exports = function(grunt) {
    ...
    var conf = {
        js_files_concat: {
            'assets/scripts/module/cookie-frontend.js': [
                'assets/scripts/src/module/cookie/frontend.js'
            ]
        },
        ...
        uglify: {
            all: {
                files: [{
                    ...
                    cwd: 'assets/scripts/module',
                    dest: 'assets/scripts/module',
                    ext: '.min.js',
                    extDot: 'last'
                }],
                options: {
